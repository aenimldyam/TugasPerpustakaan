                ...
                <div class="panel-body">
                    ...
                    <form action="<?php echo base_url('admin/update-admin'); ?>" method="post">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="username" value="<?php echo $data_admin['username_admin'];?>" readonly="readonly" placeholder="Masukkan Username Admin" required="required">
                        </div>
                        <div style="clear:both;"></div>
